...
angular.module('app')
    .directive('pageTitle', [
        '$rootScope', '$timeout','$breadcrumb',
        function($rootScope, $timeout,$breadcrumb) {
            return {
                link: function(scope, element) {
                    ...
                    $breadcrumb.$getLastViewScope().$watch(function(){
                    	var lable = $breadcrumb.$getLastViewScope().$state.current.ncyBreadcrumbLabel;
                    	$(".page-header>.header-title>h1").text( lable );
                    });
