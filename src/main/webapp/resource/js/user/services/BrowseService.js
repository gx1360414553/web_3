'use strict';
app.service('browseService', [function() {
	...
	function save( options ){
		...
		options.url = urls.ms+"/user/browse/save.do";
		ajax( options );
	}
	
	function getById( options ){
		options.url = urls.ms+"/user/browse/get.do";
		ajax( options );
	}
	
	function remove( options ){
		options.url = urls.ms+"/user/browse/delete.do";
		ajax( options );
	}
