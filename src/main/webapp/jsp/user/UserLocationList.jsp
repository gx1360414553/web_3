...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/user/services/UserLocationService.js"></script>
<script type="text/javascript" src="resource/js/user/controllers/UserLocationController.js"></script>
</head>
<body>
<div class="row" ng-controller="userLocationCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.userLocationId" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.areaCode" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            <span class="input-group-addon">联系人昵称</span>
				...
				<!-- 表格 -->
                <table id="userLocationList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="userLocationPager"></div>
