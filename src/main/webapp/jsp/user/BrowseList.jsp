...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/user/services/BrowseService.js"></script>
<script type="text/javascript" src="resource/js/user/controllers/BrowseController.js"></script>
</head>
<body>
<div class="row" ng-controller="browseCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
				...
				<!-- 表格 -->
                <table id="browseList" style="width: 100%"></table>
				<!-- 分页 -->
