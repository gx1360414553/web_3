...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/user/services/EarningsItemService.js"></script>
<script type="text/javascript" src="resource/js/user/controllers/EarningsItemController.js"></script>
</head>
<body>
<div class="row" ng-controller="earningsItemCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.earningsItemId" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            <span class="input-group-addon">任务社区ID</span>
				...
				<!-- 表格 -->
                <table id="earningsItemList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="earningsItemPager"></div>
