...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/user/services/RechargeService.js"></script>
<script type="text/javascript" src="resource/js/user/controllers/RechargeController.js"></script>
</head>
<body>
<div class="row" ng-controller="rechargeCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.rechargeId" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            <span class="input-group-addon">充值时余额</span>
		                            <input ng-model="search.preAmount" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.serviceFee" type="text" class="form-control">
		                        </div>
		                    </div>
				...
				<!-- 表格 -->
                <table id="rechargeList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="rechargePager"></div>
