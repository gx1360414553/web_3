...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/goods/services/GoodsAttributeService.js"></script>
<script type="text/javascript" src="resource/js/goods/controllers/GoodsAttributeController.js"></script>
</head>
<body>
<div class="row" ng-controller="goodsAttributeCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.goodsAttributeId" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            <span class="input-group-addon">商品属性ID</span>
				...
				<!-- 表格 -->
                <table id="goodsAttributeList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="goodsAttributePager"></div>
