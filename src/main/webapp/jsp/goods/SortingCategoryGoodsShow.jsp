...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{sortingCategoryGoods.sortingCategoryGoodsId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">货品ID</label>
	   <div class="col-sm-10">
	   		{{sortingCategoryGoods.goodsId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">分拣类别ID</label>
	   <div class="col-sm-10">
	   		{{sortingCategoryGoods.sortingCategoryId}}
	   </div>
	</div>
