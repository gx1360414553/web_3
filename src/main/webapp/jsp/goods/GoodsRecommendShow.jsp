...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{goodsRecommend.goodsRecommendId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">货品ID</label>
	   <div class="col-sm-10">
	   		{{goodsRecommend.goodsId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">被推荐的货品ID</label>
	   <div class="col-sm-10">
	   		{{goodsRecommend.recommendId}}
	   </div>
	</div>
