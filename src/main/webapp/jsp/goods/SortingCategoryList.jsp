...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/goods/services/SortingCategoryService.js"></script>
<script type="text/javascript" src="resource/js/goods/controllers/SortingCategoryController.js"></script>
</head>
<body>
<div class="row" ng-controller="sortingCategoryCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.rank" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
				...
				<!-- 表格 -->
                <table id="sortingCategoryList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="sortingCategoryPager"></div>
