...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/goods/services/SkuAttributeService.js"></script>
<script type="text/javascript" src="resource/js/goods/controllers/SkuAttributeController.js"></script>
</head>
<body>
<div class="row" ng-controller="skuAttributeCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
            	<form class="form-inline">
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input ng-model="search.skuAttributeId" type="text" class="form-control">
		                        </div>
		                    </div>
							<div class="form-group form-group-margin">
		                        <div class="input-group">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            <span class="input-group-addon">属性值ID</span>
		                            <input ng-model="search.attrValueId" type="text" class="form-control">
		                        </div>
		                    </div>
				...
				<!-- 表格 -->
                <table id="skuAttributeList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="skuAttributePager"></div>
