...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/goods/services/AttrValueService.js"></script>
<script type="text/javascript" src="resource/js/goods/controllers/AttrValueController.js"></script>
</head>
<body>
<div class="row" ng-controller="attrValueCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
				...
				<!-- 表格 -->
                <table id="attrValueList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="attrValuePager"></div>
