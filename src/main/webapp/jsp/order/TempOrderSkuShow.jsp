...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{tempOrderSku.quantity}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">社区ID</label>
	   <div class="col-sm-10">
	   		{{tempOrderSku.communityId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">采买费</label>
	   <div class="col-sm-10">
	   		{{tempOrderSku.buyFee}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">分拣类别</label>
	   <div class="col-sm-10">
	   		{{tempOrderSku.sortingCategoryId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">创建时间</label>
	   <div class="col-sm-10">
	   		{{tempOrderSku.createTime | date:'yyyy-MM-dd HH:mm:ss'}}
	   </div>
	</div>
