...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/community/services/SupermarketService.js"></script>
<script type="text/javascript" src="resource/js/community/controllers/SupermarketController.js"></script>
</head>
<body>
<div class="row" ng-controller="supermarketCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
				...
				<!-- 表格 -->
                <table id="supermarketList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="supermarketPager"></div>
