...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{routeCommunity.routeCommunityId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">路线ID</label>
	   <div class="col-sm-10">
	   		{{routeCommunity.routeId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">社区ID</label>
	   <div class="col-sm-10">
	   		{{routeCommunity.communityId}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{routeCommunity.createTime | date:'yyyy-MM-dd HH:mm:ss'}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">流转时间</label>
	   <div class="col-sm-10">
	   		{{routeCommunity.routeTime | date:'yyyy-MM-dd HH:mm:ss'}}
	   </div>
	</div>
