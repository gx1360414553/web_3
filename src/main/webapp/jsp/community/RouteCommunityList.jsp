...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/community/services/RouteCommunityService.js"></script>
<script type="text/javascript" src="resource/js/community/controllers/RouteCommunityController.js"></script>
</head>
<body>
<div class="row" ng-controller="routeCommunityCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
				...
				<!-- 表格 -->
                <table id="routeCommunityList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="routeCommunityPager"></div>
