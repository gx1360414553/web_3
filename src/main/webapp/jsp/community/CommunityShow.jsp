...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{community.createTime | date:'yyyy-MM-dd HH:mm:ss'}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   ...
	   <div class="col-sm-10">
	   		{{community.lastModify | date:'yyyy-MM-dd HH:mm:ss'}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">是否已被删除</label>
	   <div class="col-sm-10">
	   		{{community.removed}}
	   </div>
	</div>
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">经度</label>
	   <div class="col-sm-10">
	   		{{community.longitude}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">纬度</label>
	   <div class="col-sm-10">
	   		{{community.latitude}}
	   </div>
	</div>
