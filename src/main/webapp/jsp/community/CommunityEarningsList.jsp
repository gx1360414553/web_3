...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/community/services/CommunityEarningsService.js"></script>
<script type="text/javascript" src="resource/js/community/controllers/CommunityEarningsController.js"></script>
</head>
<body>
<div class="row" ng-controller="communityEarningsCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
				...
				<!-- 表格 -->
                <table id="communityEarningsList" style="width: 100%"></table>
				<!-- 分页 -->
				<div id="communityEarningsPager"></div>
