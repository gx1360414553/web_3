...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/system/controllers/AdSelectGoodsSkuController.js"></script>
<style type="text/css">
#cb_goodsRecommandList{
	display: none
}
.modal-dialog{
	width: 70%;
...
<body>
<div class="row" ng-controller="AdSelectGoodsSkuCtrl">
