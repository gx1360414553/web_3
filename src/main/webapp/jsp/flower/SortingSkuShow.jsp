...
<div class="row" style="max-height: 500px;overflow: auto;">
	...
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">流转收货数量</label>
	   <div class="col-sm-10">
	   		{{sortingSku.flowerQuantity}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
	   <label for="inputEmail3" class="col-sm-2 no-padding-right" style="text-align: right;">流转收货操作</label>
	   <div class="col-sm-10">
	   		{{sortingSku.flowerOption}}
	   </div>
	</div>
	<div class="form-group col-lg-6 col-xs-6 col-sm-12">
